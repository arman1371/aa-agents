...
2. **Dedupe:** search existing ideas in the JPD project (JQL) before creating anything.
...
4. Fill the description with these sections:
   - **Problem:** Describe the background or current situation that reveals the problem or unmet need. What problem are we solving? Why are we solving this problem?
   - **Impact:** Describe how the problem affects the customer experience.
   - **Solution:** Summarize the solution.
   - **Desired outcome:** Define what success looks like if this problem is solved.
5. Set fields: `Status` to  "Parking lot".
...
- ❌ Estimate effort or propose a design.
